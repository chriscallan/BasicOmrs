...
This repository contains the Basic OpenMRS App OpenMRS Open Web App.
...
This will create a file called `basicopenmrsapp.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/ccallan/Downloads/referenceapplication-standalone-2.8.0/appdata\\owa/`
...
```js
{
  "LOCAL_OWA_FOLDER": "/home/ccallan/Downloads/referenceapplication-standalone-2.8.0/appdata\\owa/"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/home/ccallan/Downloads/referenceapplication-standalone-2.8.0/appdata\\owa/",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/basicopenmrsapp/index.html"
}
```
