 ...
 */
// generated on 2018-12-10 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'basicopenmrsapp';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/basicopenmrsapp`,
	  css: `${__dirname}/app/css/basicopenmrsapp.css`,
	  vendor : [
